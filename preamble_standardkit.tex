...
% make new bigcdot letter for title
\makeatletter
...
\title{\Large RoboCupJunior Soccer Entry Standard Kit Rules 2023 (Draft) \vspace{2ex} \\ \large 1:1 Entry Standard Kit $\bigcdot$ Draft \vspace{-10ex}}
\date{\vspace{-2ex}}
...
\begin{tabular}{lr}
    \multicolumn{2}{l}{\textbf{Soccer Germany 2023:}}\\
    Joachim Selke             & Regional Rep. Germany,\\
                              & Speaker of the \\
                              & German Regional Committee\\
    Marco Dankel              & Soccer OC Chair\\
    Steffen Burke             & Soccer OC \\
    Christian Rieseberg       & Soccer OC\\
\end{tabular}}
&
\resizebox{0.50\textwidth}{!}{
\begin{tabular}{lr}
