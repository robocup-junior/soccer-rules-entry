...
2024 season. They are released by the RoboCup Junior League Committee. 
The English version of these rules has priority over any translations.

The aim of this document is to provide entry-level rulesets for RoboCup Junior Soccer
...
Light Weight League uses. Please see <<ball>> for balls specifications.
...
Due to availaibility concerns with sensors and future products suitable for
RoboCup Soccer use the restrictions to only Lego and Fischertechnik parts were
...
* A weight limit of 800g is introduced
...
|height | 22.4 cm ^[2]^ | 22.0 cm +
|weight | 800 g | 1100 g ^[3]^ +
...
{++A maxmimum of two driving motors is allowed.++} Only motors
...
++{A weight limit of 800g is introduced to prevent heavy custom robots from
...
{++A maxmimum of three drive motors is allowed++}
...
[appendix]
[[motor-whitelist]]
{++The below list of motors most likely be allowed in all *1:1 Standard Kit Leage* tournaments.
