= RoboCupJunior Soccer Entry Rules 2022
{docdate}
:toc: left
:sectanchors:
:sectlinks:
...
These are the RoboCup Junior Soccer Entry rules for the *1:1 Standard Kit League*,
proposed for the super-region of Europe for the 2022 season. They are
